...
insert into products(id, name, price, size, sales, image_path, category_id, regtime, edittime) VALUES (3, 'Django', 0, '40 x 40 mm', 8, '/static/django.png', 2, now(), now());
...
insert into products(id, name, price, size, sales, image_path, category_id, regtime, edittime) VALUES (6, 'IntelliJ', 1300, '40 x 40 mm', 80, '/static/intellij.png', 4, now(), now());
...
insert into products(id, name, price, size, sales, image_path, category_id, regtime, edittime) VALUES (10, 'Rails', 3000, '40 x 40 mm', 5, '/static/radis.png', 2, now(), now());
